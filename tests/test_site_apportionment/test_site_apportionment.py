...
def create_input_df():
    ...
    data = [
        ...
        # below, the case of Form sent out status imputed by TMI
...
def create_exp_percent_test_output_df():
    ...
    data = [
        [111, 0, "2020", "0006", np.nan, 100.0, np.nan, "Clear", "R", "NP10 5XX", "cym"],
        [111, 1, "2020", "0006", np.nan, 100.0, np.nan, "Clear", "R", "NP10 5XX", "cym"],
        ...
        [555, 1, "2020", "0001",  np.nan, np.nan, np.nan, "Form sent out", "No mean found", "SA50 5BE", "cym"],
        # below, the case of short form in previous period and long form in current period
...
class TestCountUniquePostcodesInCol:
    ...
    def test_count_unique_postcodes_in_col(self, create_input_df, create_exp_postcode_count_output_df):
        ...
        assert_frame_equal(result_df[expected_output_df.columns], expected_output_df, check_dtype=False)
...
class TestRunApportionSites(object):
    ...
    def create_exp_output_df(self):
        ...
        data = [
            [111, 0, "2020", "C", "A", 40, "0006", np.nan, np.nan, np.nan, 100.0, "Clear", "R", "NP10 5XX", "cym", "eng"],
            [111, 1, "2020", "C", "A", 40, "0006", np.nan, np.nan, np.nan, 100.0, "Clear", "R", "NP10 5XX", "cym", "eng"],
            [111, 2, "2020", "C", "A", 40, "0006", np.nan, np.nan, np.nan, 100.0, "Clear", "R", "NP10 5XX", "cym", "eng"],
